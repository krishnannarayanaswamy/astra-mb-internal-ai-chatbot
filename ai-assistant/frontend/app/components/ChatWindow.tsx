...
const MODEL_TYPES = ["openai_gpt_3_5_turbo", "openai_gpt_4_0", "anthropic_claude_3_opus"];
            ...
            >
              ...
              >
                <Heading
                  ...
                  color={"white"}
                >
                  Document Q&A ChatBot Astra Langchain
                </Heading>
                {messages.length > 0 ? (
                  <Heading
                    fontSize="md"
                  ...
                  <div className="flex items-center mb-2">
                    ...
                    {llmIsLoading ? (
                      ...
                      >
                        ...
                        <option value="openai_gpt_4_0">
                          GPT-40
                        </option>
                        <option value="anthropic_claude_3_opus">
                          Claude 3 Opus
                        </option>
              ...
              >
                <AutoResizeTextarea
                  ...
                  maxRows={5}
                  marginRight={"56px"}
                  placeholder="Hồ sơ pháp lý của Hồ sơ vay vốn khách hàng doanh nghiệp gồm ?"
                  textColor={"white"}
